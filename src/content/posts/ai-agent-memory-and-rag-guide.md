---
title: AI Agent 记忆系统与 RAG（检索增强生成）
published: 2026-05-26
description: 系统性地总结了构建复杂 AI Agent 时的两大核心数据支撑体系：**记忆系统（Memory）**与**检索增强生成（RAG）**。从认知科学映射、底层物理实现、工业级优化算法以及系统设计法则等维度，为你提供全方位的智能体数据架构师视角。'
image: ''
tags: ['Memory', 'RAG']
category: ''
draft: false 
